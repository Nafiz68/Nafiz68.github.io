  ...
  return (
    <section id="skills" className="py-24 border-t border-surface-variant/30 max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop relative" ref={sectionRef}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-24">
        ...
        <article className="bg-white dark:bg-[#191c1e] rounded-xl p-8 border border-outline-variant/30 flex flex-col soft-shadow">
          <header className="mb-8 flex items-center gap-3">
            <div className="w-10 h-10 rounded-lg bg-primary/5 dark:bg-inverse-primary/5 flex items-center justify-center text-primary dark:text-inverse-primary">
